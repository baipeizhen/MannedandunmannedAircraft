<template>
  <div class="not-found" :style="{ backgroundColor: isLightOn ? 'white' : 'black' }">
    ...
    <div class="not-found-font not-found-font-top" :style="{ color: isLightOn ? 'black' : 'white' }">
      <a>{{ font.font1 }}</a>
    </div>
    <div class="not-found-eye">
      <div class="not-found-eye-circle not-found-eye-circle-left" :style="{ backgroundColor: isLightOn ? '#f0f0f0' : 'white' }">
        <div class="not-found-eye-circle-inner not-found-eye-circle-inner-left"></div>
      </div>
      <div class="not-found-eye-circle not-found-eye-circle-right" :style="{ backgroundColor: isLightOn ? '#f0f0f0' : 'white' }">
        <div class="not-found-eye-circle-inner not-found-eye-circle-inner-right"></div>
      </div>
    </div>
    <div class="not-found-font not-found-font-bottom" :style="{ color: isLightOn ? 'black' : 'white' }">
      <a>{{ font.font2 }}</a>
      <p>{{ font.font3 }}</p>
    </div>
  </div>
...
// 处理眼睛动画的函数
const handleEyeAnimation = (e: MouseEvent, bounds: DOMRect, animatable: any, limitRange: number) => {
